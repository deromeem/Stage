...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_annuaire&view=offre&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_ANNUAIRE_OFFRES_NOM'), 'nom', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_ANNUAIRE_OFFRES_PRENOM'), 'prenom', $listDirn, $listOrder) ?>
				</th>
				<!-- <th class="title">Publié</th> -->
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_ANNUAIRE_OFFRES_TYPEOFFRE'), 'typeoffre', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_ANNUAIRE_OFFRES_ENTREPRISE'), 'entreprise', $listDirn, $listOrder) ?>
				</th>
