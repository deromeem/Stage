...
$uriCompoDetail = JURI::base(true)."/index.php?option=com_stage&view=utilisateur&id=";
...
<form action="<?php echo JUri::getInstance()->toString(); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div class="form-inline form-inline-header">
		...
		<div class="btn-group pull-left">
			<a href="<?php echo JRoute::_('index.php?option=com_stage&view=form_c&layout=edit'); ?>" class="btn" role="button"><span class="icon-plus"></span></a>
		</div>	
	...
	<table class="table table-striped" id="articleList">
		<thead>
			<tr>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_STAGE_UTILISATEURS_NOM'), 'nom', $listDirn, $listOrder) ?>
				</th>
				<th class="title">
					<?php echo JHtml::_('grid.sort', JText::_('COM_STAGE_UTILISATEURS_PRENOM'), 'prenom', $listDirn, $listOrder) ?>
				</th>
