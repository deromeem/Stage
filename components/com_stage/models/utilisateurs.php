...
class StageModelUtilisateurs extends JModelList
{
	...
	protected function _getListQuery()
	{
		...
		$query->select('c.id, c.nom, c.prenom, c.email, c.published, c.hits, c.modified');
		$query->from('#__stage_utilisateurs c');
